...
<div class="container mx-auto py-8">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Vak Bewerken</h1>
        <a href="{{ route('vakken.show', 1) }}" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('vakken.update', 1) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="naam" name="naam" value="Wiskunde" required placeholder="Bijv. Wiskunde" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="niveau" name="niveau" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <option value="4 HAVO" selected>4 HAVO</option>
                    ...
                    <div>
                        ...
                        <select id="kleur" name="kleur" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="blue" selected>Blauw</option>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div>
                    ...
                    <textarea id="beschrijving" name="beschrijving" rows="4" placeholder="Beschrijf het vak, de inhoud en eventuele bijzonderheden..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">Dit vak behandelt de basis van kwadratische vergelijkingen voor 4 HAVO leerlingen. We focussen op het oplossen van kwadratische vergelijkingen, het tekenen van parabolen en het toepassen van deze kennis in praktische situaties.</textarea>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="max_lesvoorbereidingen" class="block text-sm font-medium text-gray-700 mb-2">Max lesvoorbereidingen</label>
                        <input type="number" id="max_lesvoorbereidingen" name="max_lesvoorbereidingen" value="20" min="1" max="100" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p class="text-sm text-gray-500 mt-1">0 = onbeperkt</p>
                    </div>
                    <div>
                        <label for="standaard_duur" class="block text-sm font-medium text-gray-700 mb-2">Standaard lesduur (minuten)</label>
                        <input type="number" id="standaard_duur" name="standaard_duur" value="50" min="15" max="120" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('vakken.show', 1) }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
                        Annuleren
                    </a>
